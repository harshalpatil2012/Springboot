...
public class RestApiController {
	...
	public ResponseEntity<?> getUser(@PathVariable("id") int id) {
		...
		if (user == null) {
			...
			return new ResponseEntity(new CustomErrorType("AppUser with id " + id 
	...
	public ResponseEntity<?> updateUser(@PathVariable("id") int id, @RequestBody AppUser user) {
		...
		if (currentUser == null) {
			logger.error("Unable to update. AppUser with id {} not found.", id);
			return new ResponseEntity(new CustomErrorType("Unable to upate. AppUser with id " + id + " not found."),
